...
export class ResturantListOpenBuffet extends Component {
    constructor(props) {
        super(props);
        this.state = {
            language: '',
              ...
              <TouchableWithoutFeedback>
                <Badge style={{ backgroundColor: '#2F3237', marginLeft: 10 }}>
                  <Text style={{ color: 'white' }}>Read More..</Text>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('ResturantDetails')}>
                        <View style={styles.GalleryBox}>
                            ...
                            <View style={{ flexDirection: 'column', padding: 10, width: responsiveWidth(55), }}>
                                ...
                                <View style={styles.GallerydescText2}>
                                    <Image source={require('../../../../assets/location-vector.png')} style={{ height: 10, width: 10, resizeMode: 'contain' }} largeHeap="true" />
                                    <Text style={styles.userdesNmae2}>Airport Road,Kuwait</Text>
                                </View>
                                <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                    <View style={{ backgroundColor: '#F2F2F2', width: responsiveWidth(30), padding: 3, borderRadius: 5, alignItems: 'center' }}>
                                        <Text>9:00AM - 11:00PM</Text>
                                    </View>
                                    <View style={{ backgroundColor: '#FFF', width: responsiveWidth(30), padding: 3, borderRadius: 5, alignItems: 'center' }}>
                                        <Text>Min KD 20.00</Text>
                                    </View>
                                </View>
