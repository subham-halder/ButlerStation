...
export class DineinFoodDetails extends Component {
    constructor(props) {
        super(props);
        this.state = {
            language: '',
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <View style={{ height: responsiveHeight(99), width: responsiveWidth(88) }}>
                                <ScrollView>
                                    <Text style={styles.portionHeaderText}>Food Details</Text>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomColor: '#E3E3E3', borderBottomWidth: 1, paddingBottom: 20, marginTop: 20 }}>
                                        ...
                                        <View style={{ flexDirection: 'column', flex: 1, alignItems: 'baseline', }}>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                                <Text style={{ color: '#000000', fontSize: responsiveFontSize(2.5), fontWeight: 'bold', marginRight: 50 }}>KD 25.00</Text>
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ marginTop: 15, borderBottomColor: '#E3E3E3', borderBottomWidth: 1, paddingBottom: 20 }}>
                                        <Text style={{ color: '#888888', fontSize: responsiveFontSize(2) }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Lorem Ipsum has been the industry's standard.</Text>

                                    </View>

                                    <View style={{ marginTop: 15, flexDirection: 'row', alignItems: 'center' }}>
                                        <Text style={{ color: '#888888', fontSize: responsiveFontSize(2), fontWeight: 'bold' }}>Choose Size</Text>
                                        <View style={{ backgroundColor: '#F2F2F2', padding: 3, paddingLeft: 5, paddingRight: 5, borderRadius: 2, marginLeft: 10 }}>
                                            <Text style={{ color: '#000000', fontSize: responsiveFontSize(1.8), }}>Choose 1 option</Text>
                                        </View>
                                    </View>
                                    <View style={{ marginTop: 10, marginLeft: 3 }}>
                                        <View style={styles.GalleryBoxModal}>
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Size S</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>KD 29.99</Text>
                                                </View>
                                                <View style={styles.settingicon}>
                                                    <CheckBox
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Size M</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>KD 37.99</Text>
                                                </View>
                                                <View style={styles.settingicon}>
                                                    <CheckBox
                                                        value={this.state.isSelected1}
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Size L</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>KD 39.99</Text>
                                                </View>
                                                <View style={styles.settingicon}>
                                                    <CheckBox
                                                        value={this.state.isSelected1}
                                    ...
                                    <View style={{ marginTop: 15, flexDirection: 'row', alignItems: 'center' }}>
                                        <Text style={{ color: '#888888', fontSize: responsiveFontSize(2), fontWeight: 'bold' }}>Choose the souce</Text>
                                        <View style={{ backgroundColor: '#F2F2F2', padding: 3, paddingLeft: 5, paddingRight: 5, borderRadius: 2, marginLeft: 10 }}>
                                            <Text style={{ color: '#000000', fontSize: responsiveFontSize(1.8), }}>Choose 1 option</Text>
                                        </View>
                                    </View>
                                    <View style={{ marginTop: 10, marginLeft: 3 }}>
                                        <View style={styles.GalleryBoxModal}>
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Chilli sauce</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>Free</Text>
                                                </View>
                                                <View style={styles.settingicon}>
                                                    <CheckBox
                                                        value={this.state.isSelected1}
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Mustard sauce</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>Free</Text>
                                                </View>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                                <View style={styles.backbutton}>
                                                    <Text style={{ color: '#515151' }}>Speacial dipping sauce</Text>
                                                </View>
                                                <View style={{ flex: 1, marginRight: 20, alignItems: 'flex-end' }}>
                                                    <Text style={{ color: '#515151', fontWeight: 'bold' }}>KD 39.99</Text>
                                                </View>
                                    ...
                                    <View style={{ marginTop: 15, flexDirection: 'row', alignItems: 'center' }}>
                                        <Text style={{ color: '#888888', fontSize: responsiveFontSize(2), fontWeight: 'bold' }}>Add Note</Text>
                                        <View style={{ backgroundColor: '#F2F2F2', padding: 3, paddingLeft: 5, paddingRight: 5, borderRadius: 2, marginLeft: 10 }}>
