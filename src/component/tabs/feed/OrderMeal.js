...
export class OrderMeal extends Component {
    ...
    componentDidMount() {
        ...
        setTimeout(() => this._scrollView.getScrollResponder().scrollTo({ x: 250, y: 0, animated: true }), 0);
    }
                ...
                <ScrollView
                    ...
                    <View style={styles.ProfileSettingcontainer}>
                        ...
                        <View style={{ flex: 1, alignItems: 'center' }}>
                            <Text style={{ fontSize: responsiveFontSize(2.5), color: '#2B2B2B', fontWeight: 'bold' }}>Order List</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', margin: 20 }}>
                            ...
                            <View style={styles.activeMenuView}>
                                <Image
                                    ...
                                    style={{ width: responsiveWidth(4), height: responsiveHeight(4) }}
                                />
                                <Text style={styles.activeMenuText}>Order Meal </Text>
                            </View>
                            </TouchableOpacity>
                    ...
                    <View style={{ margin: 20, }}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('OrderMealDetails')}>
                        <View style={styles.GalleryBox}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', margin: 10, borderBottomColor: '#E3E3E3', borderBottomWidth: 1, paddingBottom: 10 }}>
                                ...
                                <View style={{ alignItems: "flex-end" }}>
                                    <Text style={{ color: '#2F3237' }}>KD 120.00</Text>
                                </View>
                            </View>
                            <View style={{ marginLeft: 10, marginRight: 10, marginTop: 5, borderBottomColor: '#E3E3E3', borderBottomWidth: 1, paddingBottom: 10 }}>
                                <Text style={{ color: '#888888', fontSize: responsiveFontSize(1.5) }}>ITEMS</Text>
                                <Text style={{ color: '#3F3F3F' }}>6x Fish Quozi</Text>
                                <Text style={{ color: '#888888', fontSize: responsiveFontSize(1.5) }}>ORDERD ON</Text>
                                <Text style={{ color: '#3F3F3F' }}>05 June 2021 at 9:00 PM</Text>
                            </View>
                            <View style={{ marginLeft: 10, marginRight: 10, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                <View style={{ alignItems: "flex-start" }}>
                                    <Text style={{ color: '#888888', fontSize: responsiveFontSize(1.5) }}>Pending</Text>
                                </View>
                                <View style={{ alignItems: "flex-end" }}>
                                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                                    <Image
                                        source={IMAGE.ICON_CANCLE}
                                        resizeMode='contain'
                                        style={styles.cardIcon}
                                    />
                                    <Text style={{ color: '#EA2215', fontSize: responsiveFontSize(1.5),marginLeft:5 }}>Cancel Order</Text>
                                </View>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={styles.GalleryBox}>
                            ...
                            <View style={{ marginLeft: 10, marginRight: 10, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                <View style={{ alignItems: "flex-start" }}>
                                    <Text style={{ color: '#888888', fontSize: responsiveFontSize(1.5) }}>Delivered</Text>
                                </View>
                                <View style={{ alignItems: "flex-end" }}>
                                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                                    <Image
                                        source={IMAGE.ICON_REPEAT}
                                        resizeMode='contain'
                                        style={styles.cardIcon}
                                    />
                                    <Text style={{ color: '#0EAE44', fontSize: responsiveFontSize(1.5),marginLeft:5 }}>Repeat Order</Text>
                                </View>
                                </View>
                            </View>
                        </View>
