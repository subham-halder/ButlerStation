...
export class MyFavResturant extends Component {
    constructor(props) {
        super(props);
        this.state = {
            language: '',
    ...
    componentDidMount() {
        ...
        setTimeout(() => this._scrollView.getScrollResponder().scrollTo({ x: 550, y: 0, animated: true }), 0);
    }
                ...
                <ScrollView
                    ...
                    <View style={styles.ProfileSettingcontainer}>
                        ...
                        <View style={{ flex: 1, alignItems: 'center' }}>
                            <Text style={{ fontSize: responsiveFontSize(2.5), color: '#2B2B2B', fontWeight: 'bold' }}>My Favourite</Text>
                        </View>
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('MyFavResturant')}>
                                <View style={styles.activeMenuView}>
                                    <Image
                                        ...
                                        style={{ width: responsiveWidth(4), height: responsiveHeight(4) }}
                                    />
                                    <Text style={styles.activeMenuText}>My Favourite Restaurant </Text>
                                </View>
                            </TouchableOpacity>
