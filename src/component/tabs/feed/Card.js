...
export class Card extends Component {
    ...
    componentDidMount() {
        ...
        setTimeout(() => this._scrollView.getScrollResponder().scrollTo({ x: 180, y: 0, animated: true }), 0);
    }
                ...
                <ScrollView
                    ...
                    <View style={styles.ProfileSettingcontainer}>
                        ...
                        <View style={{ flex: 1, alignItems: 'center' }}>
                            <Text style={{ fontSize: responsiveFontSize(2.5), color: '#2B2B2B', fontWeight: 'bold' }}>Credit Card</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', margin: 20 }}>
                            ...
                            <View style={styles.activeMenuView}>
                                <Image
                                    ...
                                    style={{ width: responsiveWidth(4), height: responsiveHeight(4) }}
                                />
                                <Text style={styles.activeMenuText}>Save Credit Card </Text>
                            </View>
                            </TouchableOpacity>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginTop: 30 }}>
                        <View style={styles.cardSection}>
                            ...
                            <Image
                                source={IMAGE.ICON_MASTERD_CARD}
                                resizeMode='contain'
                                style={styles.cardIcon}
                            />
                            </View>
                            <View style={{ flexDirection: 'column',flex: 1,alignItems:'baseline' }}>
                                <Text style={{color:'#989898',fontSize:responsiveFontSize(2)}}>Card Number</Text>
                                <Text style={{color:'#2F3237',fontSize:responsiveFontSize(2.8)}}>XXXX-8987-7876</Text>
                            </View>
                    ...
                    <Text style={styles.portionHeaderText}>Add New Card</Text>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginTop: 30 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <View style={styles.searchSection_row1}>
                                <Image
                            ...
                            <View style={styles.searchSection_row2}>
                                <Image
                                    source={IMAGE.ICON_CREDIT_CARD}
                                    resizeMode='contain'
                                    style={styles.searchIcon}
                    ...
                    <View style={{ flexDirection: 'row', marginLeft: 12, }}>
                        <CheckBox
                            ...
                            style={styles.checkbox}
                        />
                        <Text style={styles.label}>Save my details for future purchase</Text>
                    </View>
