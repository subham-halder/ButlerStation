    ...
    render() {
        ...
        /> */}
                ...
                <ScrollView
                        ...
                        <View style={{ flexDirection: 'row', margin: 15 }}>
                            <TouchableOpacity >
                                <View style={styles.activeMenuView}>
                                    <Text style={styles.activeMenuText}>Conference </Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity>
                    ...
                    <Text style={styles.portionHeaderText}>Most popular Facilities</Text>
                    <View style={{ flexDirection: 'row', margin: 10, alignItems: 'center' }}>
                        <Image
                            source={IMAGE.ICON_BUS}
                            resizeMode='contain'
                            style={{ width: 20, height: 20, marginLeft: 10 }}
                        />
                        <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                            <Text style={{ color: '#7D7D7D', }}>Airport shuttle</Text>
                        </View>
                        <Image
                            source={IMAGE.ICON_ROOM_SERVICE}
                            resizeMode='contain'
                            style={{ width: 20, height: 20, marginLeft: 10 }}
                        />
                        <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                            <Text style={{ color: '#7D7D7D', }}>Room service</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', margin: 10, alignItems: 'center' }}>
                        <Image
                            source={IMAGE.ICON_NON_SMOKING}
                            resizeMode='contain'
                            style={{ width: 20, height: 20, marginLeft: 10 }}
                        />
                        <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                            <Text style={{ color: '#7D7D7D', }}>NON Smoking Room</Text>
                        </View>
                        <Image
                            source={IMAGE.ICON_SURFACE}
                            resizeMode='contain'
                            style={{ width: 20, height: 20, marginLeft: 10 }}
                        />
                        <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                            <Text style={{ color: '#7D7D7D', }}>Free Parking</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', margin: 15 }}>
                        ...
                        <TouchableOpacity >
                            <View style={styles.activeMenuView2}>
                                <View style={{ flexDirection: 'column', alignItems: 'center' }}>
                                    ...
                                    />
                                    <Text style={styles.activeMenuText2}>Conference 1</Text>
                                    <Text style={{ fontSize: responsiveFontSize(2), color: '#B76819', marginBottom: 10 }}>Capacity 50</Text>
                                    <TouchableWithoutFeedback>
                            ...
                            <View style={styles.inactiveMenuView2}>
                                <View style={{ flexDirection: 'column', alignItems: 'center' }}>
                                    <Image
                                        ...
                                        style={{ width: 50, height: 50, borderRadius: 25 }}
                                    />
                                    <Text style={styles.inactiveMenuText2}>Conference 2</Text>
                                    <Text style={{ fontSize: responsiveFontSize(2), color: '#ADADAD', marginBottom: 10 }}>Capacity 50</Text>
                                    <TouchableWithoutFeedback>
                    ...
                    <View style={styles.GalleryBoxfordate1}>
                        <Text style={{ color: '#303030', fontSize: responsiveFontSize(2), marginBottom: 5, marginTop: 5 }}>Details</Text>
                        <Text style={{ color: '#66686B', fontSize: responsiveFontSize(1.5) }}>It is a long established fact that a reader will be distracted
                            by the readable content of a page when looking at
                            its layout.</Text>
                        <Text style={{ color: '#303030', fontSize: responsiveFontSize(2), marginBottom: 5, marginTop: 5 }}>Images</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: '#303030', fontSize: responsiveFontSize(2), marginBottom: 5, marginTop: 5 }}>Benefits</Text>
                        <View style={{ flexDirection: 'row', margin: 5, alignItems: 'center' }}>
                            <Image
                                source={IMAGE.ICON_FORK}
                                resizeMode='contain'
                                style={{ width: 20, height: 20, marginLeft: 10 }}
                            />
                            <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                                <Text style={{ color: '#7D7D7D', }}>Resturant</Text>
                            </View>
                            <Image
                                source={IMAGE.ICON_WIFI}
                                resizeMode='contain'
                                style={{ width: 20, height: 20, marginLeft: 10 }}
                            />
                            <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                                <Text style={{ color: '#7D7D7D', }}>Free high speed wifi </Text>
                            </View>
                        </View>
                        <View style={{ flexDirection: 'row', margin: 5, alignItems: 'center' }}>
                            <Image
                                source={IMAGE.ICON_DRYING}
                                resizeMode='contain'
                                style={{ width: 20, height: 20, marginLeft: 10 }}
                            />
                            <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                                <Text style={{ color: '#7D7D7D', }}>Drying room</Text>
                            </View>
                            <Image
                                source={IMAGE.ICON_FASHION}
                                resizeMode='contain'
                                style={{ width: 20, height: 20, marginLeft: 10 }}
                            />
                            <View style={{ flex: 1, marginRight: 20, marginLeft: 20, }}>
                                <Text style={{ color: '#7D7D7D', }}>Laundry Facilities</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={styles.portionHeaderText}>Add on <Text>(Spacial Services)</Text></Text>
                        <View style={{ backgroundColor: '#F2F2F2', padding: 3, paddingLeft: 5, paddingRight: 5, borderRadius: 2, marginLeft: 10 }}>
                            <Text style={{ color: '#000000', fontSize: responsiveFontSize(1.8), }}>Optional</Text>
                        </View>
                    </View>
                    <View style={styles.AddonBox}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 0, marginTop: 0 }}>
                            ...
                            <View style={{ flexDirection: 'column', flex: 1, alignItems: 'baseline' }}>
                                <Text style={{ color: '#A5A5A5', fontSize: responsiveFontSize(2), fontWeight: '500' }}>Projector</Text>
                                ...
                                <Text style={{ color: '#2A2A2A', fontSize: responsiveFontSize(2), }}>KD 20.00</Text>
                    ...
                    <View style={styles.AddonBox}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 0, marginTop: 0 }}>
                            ...
                            <View style={{ flexDirection: 'column', flex: 1, alignItems: 'baseline' }}>
                                <Text style={{ color: '#A5A5A5', fontSize: responsiveFontSize(2), fontWeight: '500' }}>Conference Room Board</Text>
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5, marginBottom: 5 }}>
                                    <View style={{ backgroundColor: '#EBE1D7', padding: 5, borderRadius: 5, marginRight: 10 }}>
                                        <FontAwesomeIcon name="minus" size={15} color="#000000" />
                                    </View>
                    ...
                    <View style={styles.AddonBox}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 0, marginTop: 0 }}>
                            ...
                            <View style={{ flexDirection: 'column', flex: 1, alignItems: 'baseline' }}>
                                <Text style={{ color: '#A5A5A5', fontSize: responsiveFontSize(2), fontWeight: '500' }}>Laptop</Text>
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5, marginBottom: 5 }}>
                                    <View style={{ backgroundColor: '#EBE1D7', padding: 5, borderRadius: 5, marginRight: 10 }}>
                                        <FontAwesomeIcon name="minus" size={15} color="#000000" />
                                    </View>
                    ...
                    <Text style={styles.portionHeaderText}>Spacial Occation</Text>
                    <View style={{ backgroundColor: '#E4E4E4', borderRadius: 5, width: responsiveWidth(90),height:responsiveHeight(7),alignSelf:'center',padding:5 }}>
                        
                    </View>
                    <Text style={styles.portionHeaderText}>Spacial Instruction</Text>
                    <View style={{ backgroundColor: '#E4E4E4', borderRadius: 5, width: responsiveWidth(90),height:responsiveHeight(7),alignSelf:'center',padding:5 }}>
                        
                    </View>
                    <Text style={styles.portionHeaderText}>Number of guest</Text>
                    <View style={{ backgroundColor: '#E4E4E4', borderRadius: 5, width: responsiveWidth(90),height:responsiveHeight(7),alignSelf:'center',padding:5 }}>
